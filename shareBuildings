...
//    .after(`<li role="presentation"><a data-toggle="modal" data-target="#shBuModal" id="shBuOpenModal" style="cursor:pointer"><span class="glyphicon glyphicon-ok-sign"></span> Gebäude freigeben</a></li>`);
    ...
    $("#navbar_profile_link")
        .parent()
        .after(`<li role="presentation"><a style="cursor:pointer" id="shBuOpenModal" data-toggle="modal" data-target="#shBuModal" ><span class="glyphicon glyphicon-cog"></span> Gebäude freigeben</a></li>`);
